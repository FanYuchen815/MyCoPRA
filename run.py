...
# Wrap Trainer.save_checkpoint to ignore "No space left on device" errors
# This prevents training from aborting when checkpoint saving fails due to full disk.
